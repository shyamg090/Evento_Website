  ...
  return (
    <div className="w-full h-[60vh] flex items-center justify-start p-4 bg-center bg-cover" style={{ backgroundImage: `url( ${bgimage} )` }}>
      <div className="w-[50%] flex flex-col gap-4">
        <h1 className="text-white text-[1.8rem] lg:text-[4rem] font-extrabold leading-none ">Want to Add Your Event So that you can gather people and make it awesome?</h1>
        <button className="custom-button uppercase w-[8rem]" onClick={changepage}>Add Event</button>
      </div>
    </div>
  )
}
